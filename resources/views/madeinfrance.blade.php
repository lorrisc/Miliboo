    ...
    <section id="results">
        ...
        <section id="results__container">
            ...
            @foreach($monTableau as $key =>$produit)
                ...
                ?>
            <article>
                <img class ="imgmention" src="https://www.miliboo.com/assets/images/madeIn/picto_MIF_FR.svg" alt="image produit">
                <article class="productValue">
                    ...
                    <div class="product__bottom">
                        ...
                        <div class="productColor">
                            <a href="/produit/{{$idproduit}}/{{$libProduitFormat}}/{{$idcouleur}}">
                                <div class="color color{{$idcouleur}}"></div>
                            </a>
                        </div>
